...
(function (root, factory) {
     ...
     *	}
     */
    p5.SerialPortWebUSB = function (_vid, _pid) {
        var self = this;
     ...
     * 		}
     */
    p5.SerialPortWebUSB.prototype.isConnected = function () {
     ...
     * 
     * @method open
     * @param  {Boolean} Whether to connect automatically to paired device. If there is one, no device select winow will show up
     * @param  {Number} Baudrate for serial
     ...
     *		serial.open(false);
     *		serial.open(true,115200);
     *		serial.open(false, 9600, onOpen);
     *		
     *		function onOpen() {
     *		  print('opened the serial port!');
     *		}
     */
    p5.SerialPortWebUSB.prototype.open = async function (_autoConnect=true,_baudRate=9600, cb) {
     ...
     *		}
     */
    p5.SerialPortWebUSB.prototype.write = function (data) {
     ...
     *		}
     */
    p5.SerialPortWebUSB.prototype.read = function () {
     ...
     *		}
     */
    p5.SerialPortWebUSB.prototype.readChar = function () {
        if (this.serialBuffer.length > 0) {
     ...
     *		}
     */
    p5.SerialPortWebUSB.prototype.readBytes = function () {
        if (this.serialBuffer.length > 0) {
     ...
     *		charToFind.charCodeAt(0, );
     */
    p5.SerialPortWebUSB.prototype.readBytesUntil = function (charToFind) {
     ...
     * 
     */
    p5.SerialPortWebUSB.prototype.readString = function () {
     ...
     * 		 
     * 		 var serial1 = new p5.SerialPortWebUSB();
     *		 var serial2 = new p5.SerialPortWebUSB();
     *		 var input1 = '';
     *		 var input2 = '';
     *		
     *		 function serialEvent(){
     ...
     *		 }
     */
    p5.SerialPortWebUSB.prototype.readStringUntil = function (stringToFind) {
     ...
     *			}
     */
    p5.SerialPortWebUSB.prototype.readLine = function () {
     ...
     *			}
     * */
    p5.SerialPortWebUSB.prototype.available = function () {
     ...
     * 
     * */
    p5.SerialPortWebUSB.prototype.last = function () {
     ...
     * 
     * */
    p5.SerialPortWebUSB.prototype.lastChar = function () {
     ...
     * @example
     */
    p5.SerialPortWebUSB.prototype.clear = function () {
     ...
     * 
     */
    p5.SerialPortWebUSB.prototype.stop = function () {};
     ...
     *		}  
     */
    p5.SerialPortWebUSB.prototype.close = async function (cb) {
        // 
        if (typeof cb === 'function') {
     ...
     * }
     */
    // p5.SerialPortWebUSB.prototype.registerClient = function(cb) {
    //   if (typeof cb === 'function') {
     ...
     * 
     */
    p5.SerialPortWebUSB.prototype.onData = function (_callback) {
        this.on('data', _callback);
    };

    p5.SerialPortWebUSB.prototype.onOpen = function (_callback) {
        this.on('open', _callback);
    };

    p5.SerialPortWebUSB.prototype.onClose = function (_callback) {
        this.on('close', _callback);
    };

    p5.SerialPortWebUSB.prototype.onError = function (_callback) {
        this.on('error', _callback);
    };
    
    p5.SerialPortWebUSB.prototype.onRawData = function(_callback) {
        this.on('rawdata',_callback);
    };

    // Version 2
    p5.SerialPortWebUSB.prototype.on = function (_event, _callback) {
        if (_event == 'open') {
